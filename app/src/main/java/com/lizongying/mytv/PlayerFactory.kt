...
object PlayerFactory {
    ...
    private val PROTOCOL_PLAYER_MAP = mapOf(
        ...
        // 其他流媒体协议
        "rtmp://" to UnifiedVideoPlayer.PlayerType.GSY_PLAYER,
        "rtmps://" to UnifiedVideoPlayer.PlayerType.GSY_PLAYER,
        "rtmpt://" to UnifiedVideoPlayer.PlayerType.GSY_PLAYER,
        "rtmpts://" to UnifiedVideoPlayer.PlayerType.GSY_PLAYER,
        "mms://" to UnifiedVideoPlayer.PlayerType.GSY_PLAYER
    )
    ...
    fun detectPlayerType(url: String): UnifiedVideoPlayer.PlayerType {
        ...
        when {
            ...
            lowerUrl.contains("rtp") || lowerUrl.contains("udp") -> {
                Log.d(TAG, "检测到RTP/UDP关键词，选择GSYVideoPlayer")
     ...
     * 创建GSYVideoPlayer实例
     */
    private fun createIjkPlayer(context: Context): GsyPlayerWrapper {
        Log.d(TAG, "创建GSYVideoPlayer实例")
        val player = GsyPlayerWrapper()
