...
# Note: --disable-avresample removed, libavresample was dropped in FFmpeg 4.0+
...
# MediaCodec hardware decoders (Android)
...
export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-decoder=mpeg2_mediacodec"
...
# Note: ijk* demuxers are ijkplayer-specific, not available in official FFmpeg
...
# hevc_mp4toannexb_bsf needed by hevc_mediacodec_decoder
